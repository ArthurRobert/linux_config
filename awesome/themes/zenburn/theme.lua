...
-- {{{ Main
theme = {}
theme.wallpaper = "~/.config/awesome/wallpaper/arch_pacman.png"
-- }}}
...
theme.titlebar_ontop_button_focus_inactive  = "~/.config/awesome/themess/zenburn/titlebar/ontop_focus_inactive.png"
theme.titlebar_ontop_button_normal_inactive = "~/.config/awesome/themess/zenburn/titlebar/ontop_normal_inactive.png"
